  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
        <Link href="/forum/topics" className="bg-white shadow-md rounded-lg p-6 hover:shadow-lg transition-shadow">
          <h2 className="text-xl font-bold mb-2">토픽</h2>
          <p className="text-gray-600">모든 토픽 목록 보기</p>
        </Link>
        
        <Link href="/forum/users" className="bg-white shadow-md rounded-lg p-6 hover:shadow-lg transition-shadow">
          <h2 className="text-xl font-bold mb-2">유저</h2>
          <p className="text-gray-600">활발한 유저 목록 보기</p>
        </Link>
        
        <Link href="/forum/badge" className="bg-white shadow-md rounded-lg p-6 hover:shadow-lg transition-shadow">
          <h2 className="text-xl font-bold mb-2">배지</h2>
          <p className="text-gray-600">획득 가능한 배지 보기</p>
        </Link>
      </div>
    </div>
  )
